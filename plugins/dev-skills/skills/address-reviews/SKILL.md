...
- [ ] Stacks detected only by matching fully qualified repository/ref pairs; any enabled rebase ran base-before-dependent, and every rebase-enabled dependent of a newly merged parent was restacked and checked for parent content in its diff.
