...
- [ ] Fixes done inline or via a fixer subagent (one checkout-dependent agent at a time); same-pattern sweep done in changed/related code, its search space enumerated per `review-cycle`.
