...
- Every peer-prompt constructor in this repo carries the same convention — the Claude skills, their Codex mirrors, and the workflow rendering — so no consumer drifts on the peer-prompt shape.
