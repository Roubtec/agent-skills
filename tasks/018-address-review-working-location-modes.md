...
- The `address-reviews` attach recipe no longer pairs a detached worktree with a bare `gh pr checkout <N>`, so a same-named local branch cannot be selected through it.
