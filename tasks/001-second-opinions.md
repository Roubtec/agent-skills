...
All of 001a–001f merged; both trees describe the identical protocol (allowing for harness-specific invocation syntax); `rg -n "3 rounds|3 iterations|round 3" plugins/ codex/` returns no stale budget references.
