...
- The re-review call and its state object: `plugins/dev-skills/workflows/wf-address-tasks.js:2433`, in the `isChanged` arm of the `heldTasks` dispatch. Line number as of PR #55's head; the anchor is the `re-review:${task.slug}` agent label.
