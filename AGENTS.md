...
Use one line per paragraph in Markdown if possible, or one line per sentence in SKILL files. No need to pre-wrap lines in commit messages. (Do not dwell on or point out existing line wrapping transgression in reviews, just follow the rules going forward.)
