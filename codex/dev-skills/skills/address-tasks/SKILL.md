...
- Each task: its PR link (or "local branch only" if PRs were skipped) and its terminal state — delivered, merged during the run, pushed without a PR, held by the guard, capped, crashed, or skipped for a failed prerequisite.
